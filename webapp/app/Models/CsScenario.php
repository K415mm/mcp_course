...
class CsScenario
{
    ...
    private static function phantomGrid(): array
    {
        return [
            ...
            'phases' => [
                ['index' => 0, 'name' => 'OUVERTURE',   'tag' => 'PHASE 0', 'desc' => 'Mise en situation & prise de rôle',          'duration_seconds' => 600],
                ['index' => 1, 'name' => 'DÉTECTION',   'tag' => 'PHASE 1', 'desc' => 'Signaux faibles & incertitude initiale',     'duration_seconds' => 1800],
                ['index' => 2, 'name' => 'AMPLIFICATION','tag' => 'PHASE 2', 'desc' => 'Impacts sur les services essentiels',        'duration_seconds' => 2400],
                ['index' => 3, 'name' => 'CRISE MÉDIAS','tag' => 'PHASE 3', 'desc' => 'Pression médiatique & institutionnelle',     'duration_seconds' => 2400],
                ['index' => 4, 'name' => 'ARBITRAGE',   'tag' => 'PHASE 4', 'desc' => 'Décisions stratégiques sous contrainte',     'duration_seconds' => 1200],
                ['index' => 5, 'name' => 'CLÔTURE',     'tag' => 'FIN',     'desc' => 'Restitution & cérémonie des badges',         'duration_seconds' => 600],
            ],
            'vote_options' => [
