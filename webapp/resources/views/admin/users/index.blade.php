                            ...
                            <td class="text-end pe-3">
                                <div class="btn-group">
                                    ...
                                    @if($user->id !== auth()->id())
                                        ...
                                        {{-- Verify User --}}
                                        <form method="POST" action="{{ route('admin.users.verify', $user) }}" class="d-inline" onsubmit="return confirmFormSubmit(event, 'Manually verify this user?');">
                                            @csrf
                                        ...
                                        {{-- Delete User --}}
                                        <form method="POST" action="{{ route('admin.users.destroy', $user) }}" class="d-inline" onsubmit="return confirmFormSubmit(event, 'WARNING: This will permanently delete this user and all their progress. Continue?');">
                                            @csrf
                                            @method('DELETE')
